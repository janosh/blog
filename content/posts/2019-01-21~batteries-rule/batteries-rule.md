...
Even if our energy demands should exceed the amount of sun light reaching the Earth, i.e. increase by more than a factor of the number of hours in a year ($24 \times 365 = 8760$), all we'd have to do is start harnessing solar radation from space. This has a number of advantages anyway.
...
But I digress. Basically my point is that solar energy is obviously by far the best long-term solution for all our energy needs and - here comes the core message of this blog post - perhaps slightly less obviously when combined with large-scale batteries the best short term solution as well.
