<script lang="ts">
  ...
  let PaperComponent: typeof PaperGrid | typeof PaperTimeline = $state(PaperGrid)
  ...
  <section class="body">
    ...
    <div class="view-toggle">
      {#each [
        ...
        <button
          class:active={PaperComponent === Component}
          onclick={() => PaperComponent = Component}
        >
          <Icon {icon} /> {label}
        </button>
      {/each}
    ...
    <PaperComponent papers={papers.references} />
