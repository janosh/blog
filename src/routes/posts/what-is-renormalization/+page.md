...
I want to give an intuitive understanding of the process of **renormalization** and why it's useful. But to that, I first need to introduce the context in which the need for renormalization arose: **quantum field theory**, or QFT for short. For that, I'll be [borrowing heavily from the always-excellent David Tong](https://web.archive.org/web/20260507102309/https://www.damtp.cam.ac.uk/user/tong/whatisqft.html).
