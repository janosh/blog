...
- [A tour of probabilistic programming language APIs](https://colcarroll.github.io/ppl-api) by [Colin Carroll](https://colindcarroll.com/). His entire blog is about MCMC and probabilistic programming and he has a bunch more really interesting posts on those topics. I highly recommend checking those out.
